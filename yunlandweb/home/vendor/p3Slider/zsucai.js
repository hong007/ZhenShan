...
$("#smallSlideUl").width(_focus_num * 20);
var _focus_direction = true;
var _focus_pos = 0;
var _focus_max_length = _focus_num * 1190;
var _focus_li_length = 1190;
var _focus_dsq = null;
...
$("#trippleArrowLeft").bind('click',function(){
    if (_focus_pos == 0) {
        _focus_pos = _focus_num - 1;
    }else{
        _focus_pos--
    }
    if (_focus_lock) {
...
$("#trippleArrowRight").bind('click',function(){
    if (_focus_pos == (_focus_num - 1)) {
        _focus_pos = 0;
    }else{
        _focus_pos++;
